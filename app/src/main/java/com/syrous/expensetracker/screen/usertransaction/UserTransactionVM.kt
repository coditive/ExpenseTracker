...
class UserTransactionVMImpl @Inject constructor(
    ...
    private fun transactionValuesValidator(
        ...
        _viewState.value = ViewState.Success(transactionCategory, date, type, description, amount, false)
        return UserTransaction(amount = amount, description = description, transactionCategory = transactionCategory, date = date, categoryTag = type)
    }
